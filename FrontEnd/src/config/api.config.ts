...
export const API_CONFIG = {
  ...
  ENDPOINTS: {
    ...
    COMMUNITY: {
      ...
      POST: '/community/post/create',  // Changed
      LIKE: '/community/post/like',    // Changed
      COMMENT: '/community/post/commentPost',  // Changed
      COMMENTS: '/community/post/getComments'  // Changed
    },
